        ...
        {assignments.length > 0 ? (
          assignments.map((assignment, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 p-6 hover:shadow-md dark:hover:shadow-slate-900 transition-all"
            >
          ...
          <div className="text-center py-12">
            <p className="text-gray-600 dark:text-gray-400">
              {translations.noUpcomingAssignments}
            </p>
          </div>
        )}
      </motion.div>
